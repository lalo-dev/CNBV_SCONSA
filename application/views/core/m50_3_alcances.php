                    ...
                    <div class="tab-pane fade fade-up in active" id="search-documentos">
                                    ...
                                    <div class="form-group">
                                        <div class="">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="alcance" maxlength="100" name="tipo">
                                                <!--input class="form-control input-sm" type="text" value="proceso ejemplo" id="proceso" maxlength="50" name="proceso">
                                                <label for="proceso">Proceso</label-->
                                            </div>
                                        </div>
                                         <div class="col-md-3">
                                            <div class="form-material form-material-primary floating">
                                                <select class="form-control input-sm" id="alcance" name="alcance">
                                                    <!--option></option-->
                                                    <!--option value="1">Adquiciciones</option>
                                                    <option value="2">General</option>
                                                    <option value="3">Estructura</option-->
                                                    <?php foreach($getCatalcance as $row){ 
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" value="Alcance 1" id="proceso" name="proceso">
                                                <label for="proceso">Alcance</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" value="Descripcion alcance" type="text" id="descripcion" maxlength="254" name="descripcion">
                        ...
                        <div class="table-responsive" >
                            ...
                            <table id="table_cat" class="table table-striped table-vcenter table-condensed">
                                ...
                                <tbody class=" ">                                    
                                    <?php foreach ($getAlcances as $key => $value): ?>  
                                    <tr id="id_cat_<?=$value->id  ?>" class="">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">    
                                                ...
                                                <?php if( empty($s_rol)): ?>                                                
                                                    ...
                                                    <span class="btn btn-primary btn-xs disabled" data-toggle="tooltip" onclick="javascript:void(0)" data-placement="top" title="Editar" href="#">
                                                        <i class="fa fa-pencil"></i>
                                                    </span>
                                                    <button class="btn btn-danger btn-xs disabled" type="button" data-toggle="tooltip" onclick="javascript:void(0)" data-placement="top" title="Eliminar">
...
<script src="content/vendor/js/catalogos_users_alcances.js"></script>
