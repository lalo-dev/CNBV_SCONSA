                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="esc_titulo" maxlength="50" name="tipo">
                                                <input class="form-control input-sm" type="text" value="Título ejemplo" id="proceso" maxlength="100" name="proceso">
                                                <label for="proceso">Título</label>
                                            </div>
                                        </div>                                       
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
