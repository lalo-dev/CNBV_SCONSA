...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    ...
    <body>
                                ...
                                <?= form_open_multipart('', 'id="addusuariogenform" class="js-validation-user-general form-horizontal push-10-t" ');?>
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm" id="usuario" maxlength="60" name="usuario" type="text" value="eduardo.martinez@cnbv.com">
                                                    <label for="usuario">Usuario</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm" id="pass" name="pass" maxlength="60" type="password" value="123456">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-4">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm" type="text" maxlength="60" id="nombre" name="nombre" value="nombre usuario">
                                                    <label for="nombre">Nombre</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm" type="text" maxlength="60" id="apellidop" name="apellidop" value="apellido usuario">
                                                    <label for="apellidop">Apellido Paterno</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm" type="text" maxlength="60" id="apellidom" name="apellidom" value="apellidom usuario">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-material form-material-primary">
                                                    <input class="js-datepicker form-control" type="text" id="fecha_nac" value="22-06-2016" name="fecha_nac" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy">                                                        
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm" maxlength="20" value="GJFVKJRFVNKS" type="text" id="curp" name="curp">
                                                    <label for="curp">CURP</label>
                                                </div>
                                            </div>   
                                            <div class="col-sm-3">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm"  maxlength="60" value="Guadalajara, jal" type="text" id="lugar_nac" name="lugar_nac">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-md-2">
                                                <label class="css-input switch switch-primary">
                                                    <input type="checkbox" id="estructura" name="estructura" value="estructura" checked><span></span> Estructura
                                                </label>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm" type="text" maxlength="40" id="n_expediente" name="n_expediente" value="6434">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" name="nivel_codigo" maxlength="40" type="text" value="NA1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" value="Lic" id="grado_codigo" name="grado_codigo">
                                                <label for="grado_codigo">Código</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" name="grado_cedula" value="1234567890">
                                                <label for="grado_cedula">Cedula</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" name="grado_iniciales" value="EMM">
                                                <label for="grado_iniciales">Iniciales</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="80" id="email_cnbv" name="email_cnbv" value="eduardo.martinez@cnbv.com" readonly>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="80" value="eduardo.martinez@personal.com" name="email_personal" id="email_personal" name="cpersonal">
                                                <label for="email_personal">Correo electronico personal</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" value="52-7654323456" maxlength="40" id="celular" name="celular">
                                                <label for="celular">Celular</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" value="52-963642456" maxlength="40" id="telefono" name="telefono">
                                                <label for="telefono">Teléfono</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" value="523" maxlength="40" id="telefono_ext" name="telefono_ext">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" value="direccion conocida sin numero" maxlength="60" id="direccion" name="direccion">
                                                <label for="direccion">Dirección</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" value="10" maxlength="40" id="torre" name="torre">
                                                <label for="torre">Torre</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" value="5" maxlength="40" id="piso" name="piso">
                                                <label for="piso">Piso</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" value="70,23" maxlength="40" id="coordenada" name="coordenada">
                                     ...
                                     <div class="row">
                                        <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-2">
                                                        <!--button class="btn btn-info btn-sm" style="overflow:hidden" id="btn_curr" type="button" disabled-->
                                                             <a class="btn btn-info btn-sm disabled" style="overflow:hidden" id="btn_curr" type="button" href="#"><i class="fa fa-download"></i> Descargar</a>
                                                        <!--/button-->
                                                    </div>
                                                    <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-2">
                                                        <!--button class="btn btn-info btn-sm" id="btn_perfil" type="button" disabled-->
                                                            <a class="btn btn-info btn-sm disabled" style="overflow:hidden" id="btn_perfil" type="button" href="#">
                                   ...
                                   <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-2">
                                                    <!--button class="btn btn-info btn-sm" id="btn_desempeno" type="button" disabled-->
                                                        <a class="btn btn-info btn-sm disabled" style="overflow:hidden" id="btn_desempeno" type="button" href="#">
                                                          <i class="fa fa-download"></i> Descargar
                                                        </a>
                                                    <!--/button-->
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-2">
                                                    <!--button class="btn btn-info btn-sm" style="overflow:hidden" id="btn_foto" type="button" disabled-->
                                                        <a class="btn btn-info btn-sm disabled" style="overflow:hidden" id="btn_foto" type="button" href="#">
                                                          <i class="fa fa-download"></i> Descargar
                                                        </a>
                                                    <!--/button-->
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="">
                                                    <div class="form-material form-material-primary floating">
                                                        ...
                                                        <!--input class="form-control input-sm" type="text" id="hab_habilidad_des" value="Habilidad 1" maxlength="60" name="hab_habilidad_des">
                                            ...
                                            <div class="form-group">
                                                <div class="">
                                                    <div class="form-material form-material-primary floating">
                                                        ...
                                                        <!--label for="cer_certificacion_des hidden">Certificación</label-->
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-material form-material-primary floating">
                                            ...
                                            <div class="form-group">
                                                <div class="">
                                                    <div class="form-material form-material-primary floating">
                                                        ...
                                                        <!--label for="cur_curso_des hidden">Curso</label-->
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-material form-material-primary floating">
        ...
        <script src="assets/js/plugins/ajaxfileupload.js"></script>
