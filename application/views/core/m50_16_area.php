                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="area_area" maxlength="50" name="tipo">
                                                <input class="form-control input-sm" type="text" value="Área ejemplo" id="proceso" maxlength="100" name="proceso">
                        ...
                        <div class="table-responsive" >
                            ...
                            <table id="table_cat" class="table table-striped table-vcenter table-condensed">
                                ...
                                <tbody class=" ">
                                    ...
                                    <?php foreach ($getArea as $key => $value): ?>  
