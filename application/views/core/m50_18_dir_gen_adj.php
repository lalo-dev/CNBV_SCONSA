            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Direccion Genaral Adjunta <small>Catálogo</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        ...
                        <li>Direccion General Adjunta</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="dga" maxlength="50" name="tipo">
                                                <input class="form-control input-sm" type="text" id="proceso" maxlength="100" name="proceso" placeholder="DGA">
                                                <label for="proceso">DGA</label>
                                            </div>
                                        </div>                                       
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                        ...
                        <div class="table-responsive" >
                            ...
                            <table id="table_cat" class="table table-striped table-vcenter table-condensed">
                                ...
                                <tbody class=" ">
                                    ...
                                    <?php foreach ($getDga as $key => $value): ?>
