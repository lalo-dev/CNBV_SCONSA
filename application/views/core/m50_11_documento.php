            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Documento obtenido <small>Catálogo</small>
                    </h1>
                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="esc_doc" maxlength="50" name="tipo">
                                                <input class="form-control input-sm" type="text" value="Título ejemplo" id="proceso" maxlength="100" name="proceso">
                                                <label for="proceso">Documento obtenido</label>
                                            </div>
                                        </div>                                       
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                            ...
                            <table id="table_cat" class="table table-striped table-vcenter table-condensed">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left">Documento obtenido</th>
                                ...
                                <tbody class=" ">
                                    ...
                                    <?php foreach ($getDocumentoOptenido as $key => $value): ?>  
