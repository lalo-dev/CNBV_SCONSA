                    ...
                    <div class="tab-pane fade fade-up in active" id="search-documentos">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="proceso" maxlength="50" name="tipo">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" value="descripcion" type="text" id="descripcion" maxlength="255" name="descripcion">
                        ...
                        <div class="table-responsive" >
                            ...
                            <table id="table_cat" class="table table-striped table-vcenter table-condensed">
                                ...
                                <tbody class="">                                     
                                    <?php foreach ($getProcesos as $key => $value): ?>  
