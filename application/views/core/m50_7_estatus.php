                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="nivelstatus" maxlength="50" name="tipo">
                                                <input class="form-control input-sm" type="text" value="Nivel ejemplo" id="proceso" maxlength="100" name="proceso">
                                                <label for="proceso">Estatus</label>
                                            </div>
                                        </div>                                       
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
