            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Direcciones generales <small>Catálogo</small>
                    </h1>
                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="dgs" maxlength="50" name="tipo">
                                                <input class="form-control input-sm" type="text" id="proceso" maxlength="100" name="proceso" placeholder="Dirección General">
                                                <label for="proceso">Dirección general</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" id="descripcion" maxlength="255" name="descripcion" value="Descripción">
                        ...
                        <div class="table-responsive" >
                            ...
                            <table id="table_cat" class="table table-striped table-vcenter table-condensed">
                                ...
                                <tr>
                                    ...
                                    <th class="text-left">Dirección general</th>
