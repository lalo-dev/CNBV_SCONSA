                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="area_subarea" maxlength="50" name="tipo">
                                                <input class="form-control input-sm" type="text" value="Sub área ejemplo" id="proceso" maxlength="100" name="proceso">
                                                <label for="proceso">Sub área</label>
                                            </div>
                                        </div>                                       
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                            ...
                            <table id="table_cat" class="table table-striped table-vcenter table-condensed">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left">Sub área</th>
                                ...
                                <tbody class=" ">
                                    ...
                                    <?php foreach ($getSubarea as $key => $value): ?>  
