                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="nivel" maxlength="50" name="tipo">
                                                <input class="form-control input-sm" type="text" value="Nivel ejemplo" id="proceso" maxlength="100" name="proceso">
                                                <label for="proceso">Nivel</label>
                                            </div>
                                        </div>                                       
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                        ...
                        <div class="table-responsive" >
                            ...
                            <table id="table_cat" class="table table-striped table-vcenter table-condensed">
                                ...
                                <tbody class=" ">
                                    ...
                                    <?php foreach ($getCargo as $key => $value): ?>  
