                                ...
                                <?= form_open_multipart('', 'id="addusuariogenform" class="js-validation-user-general form-horizontal push-10-t" ');?>
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm" id="usuario" maxlength="60" name="usuario" type="text" value="usuario">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm" maxlength="20" type="text" id="curp" name="curp">
                                                    <label for="curp">CURP</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm"  maxlength="60" type="text" id="lugar_nac" name="lugar_nac">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="form-material form-material-primary floating">
                                                    <div class="checkbox">
                                                        <label for="estructura">
                                                            <input type="checkbox" id="estructura" name="estructura" value="estructura"> Estructura
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm" type="text" maxlength="40" id="n_expediente" name="n_expediente" value="6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" name="grado_celula" value="1234567890">
                                                <label for="grado_celula">Cedula</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" name="grado_iniales" value="EMM">
                                                <label for="grado_iniales">Iniciales</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="60" name="email_cnbv" value="eduardo.martinez@cnbv.com">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="60" name="email_personal" id="email_personal" name="cpersonal">
                                                <label for="email_personal">Correo electronico personal</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" id="cedula" name="cedula">
                                                <label for="cedula">Celular</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" id="telefono" name="telefono">
                                                <label for="telefono">Teléfono</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" id="telefono_ext" name="telefono_ext">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="60" id="direccion" name="direccion">
                                                <label for="direccion">Dirección</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" id="torre" name="torre">
                                                <label for="torre">Torre</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" id="piso" name="piso">
                                                <label for="piso">Piso</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" maxlength="40" id="coordenada" name="coordenada">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                                    <div class="form-material form-material-primary floating">
                                                        ...
                                                        <input class="form-control input-sm" type="text" id="hab_habilidad_des" maxlength="60" name="hab_habilidad_des">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-5">
                                                    <div class="form-material form-material-primary floating">
                                                        ...
                                                        <input class="form-control input-sm" type="text" id="cer_certificacion_des" maxlength="60" name="cer_certificacion_des">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                                    <div class="form-material form-material-primary floating">
                                                        ...
                                                        <input class="form-control input-sm" type="text" id="cur_curso_des" maxlength="60" value="desc" name="cur_curso_des">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-material form-material-primary floating">
                                                        <select class="form-control input-sm" id="cur_curso" name="cur_curso">
                                                            <option value="42">Curso en XXXXXXXX</option>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-material form-material-primary floating">
                                                        <select class="form-control input-sm" id="cur_instituto" name="cur_instituto">
                                                            <option value="44">Institución XXXXXXXX</option>
