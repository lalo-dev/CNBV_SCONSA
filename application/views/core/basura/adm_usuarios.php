                        ...
                        <div class="block-content tab-content bg-white">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="Editar" href="adm_usuarios_form">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="Editar" href="adm_usuarios_form_area">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <button class="btn btn-danger btn-xs" type="button" data-toggle="tooltip" data-placement="top" title="Eliminar">
                                                        <i class="fa fa-times"></i>
                            ...
                            <div class="tab-pane" id="btabs-alt-static-settings">
                                ...
                                <div class="row">
                                    ...
                                    <?php if (empty($super_user)): ?>
                                    <?php else: ?>
                                    <?php endif; ?>
                                    <div class="col-xs-6 col-sm-2 col-lg-2 disabled">
