            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Vicepresidencia <small>Catálogo</small>
                    </h1>
                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="vicepresidencia" maxlength="50" name="tipo">
                                                <input class="form-control input-sm" type="text" value="" id="proceso" maxlength="100" name="proceso" placeholder="Vicepresidencia">
                                                <label for="proceso">Vicepresidencia</label>
                                            </div>
                                        </div>                                       
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                                                <input class="form-control input-sm" type="text" id="descripcion" maxlength="254" name="descripcion" value="Descripción">
                            ...
                            <table id="table_cat" class="table table-striped table-vcenter table-condensed">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left">Vicepresidencia</th>
                                ...
                                <tbody class=" ">
                                    ...
                                    <?php foreach ($getVicepresidencia as $key => $value): ?>  
