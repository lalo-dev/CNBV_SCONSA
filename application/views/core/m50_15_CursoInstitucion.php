            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Institución <small>Catálogo</small>
                    </h1>
                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">                                               
                                                ...
                                                <input class="form-control input-sm hidden" type="text" id="tipo" value="cur_institucion" maxlength="50" name="tipo">
                                                <input class="form-control input-sm" type="text" value="Institución ejemplo" id="proceso" maxlength="100" name="proceso">
                                                <label for="proceso">Institución</label>
                                            </div>
                                        </div>                                       
                                        <div class="col-sm-4">
                                            <div class="form-material form-material-primary floating">
                        ...
                        <div class="table-responsive" >
                            ...
                            <table id="table_cat" class="table table-striped table-vcenter table-condensed">
                                ...
                                <tbody class=" ">
                                    ...
                                    <?php foreach ($getCursoInstitucion as $key => $value): ?>  
