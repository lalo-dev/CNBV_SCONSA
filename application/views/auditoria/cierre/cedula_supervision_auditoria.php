            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Cédula de supervisón de auditoría<small> Cierre</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Cédula de supervisón de auditoría</li>
                        <li>Cierre</li>
                    </ol>
                </div>
            </div>
                            ...
                            <tr>
                                <td>
                                    <h3 class="h5 font-w600 push-10">
                                        <a class="link-effect" href="m_cedula_supervision_auditoria_detallada">Auditoría XXXX XXXXX</a>
                                    </h3>
                                </td>
