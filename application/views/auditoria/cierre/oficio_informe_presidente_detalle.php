            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> Oficio de envío del Informe para el Presidente</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Auditoría</li>
                        <li>Cierre</li>
                        <li><a href="#">Oficio de envío del Informe para el Presidente</a></li>
                        <li>Detalle</li>
                    </ol>
                </div>
            </div>
        ...
        <div class="content">
            <div class="block">
                ...
                <div class="block-content tab-content bg-white">
                    ...
                    <!-- End Info -->
                    <!-- Acta -->
                    <div class="tab-pane fade fade-up" id="area-oficio">
                            ...
                            <div class="col-md-12">
                                <form class="form-horizontal push-10-t" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="orden"># Orden Generada</label>
                                        <div class="col-md-3">
                                            <input class="form-control" type="text" id="numero_orden_generado" name="numero_orden_generado" placeholder="Verificar">
                                        </div>
                                    <!--</div>
                                    <div class="form-group">-->
                                        <label class="col-md-1 control-label" for="orden">Verificar</label>
                                        <div class="col-md-3">
                                            <input class="form-control" type="text" id="verificar" name="verificar" placeholder="Verificar">
                                        </div>
                                    </div>
                                    ...
                                    <blockquote>
                                        <div class="form-group">
                                            <fielset>
                                                ...
                                                <h5>Dirección general "A"</5></br></br>
                                                <div class="form-group">
                                                    <label class="col-md-1 control-label" for="general_a">A</label>
                                                    <div class="col-md-3">
                                                        <input class="form-control" type="text" id="direccion_general_a_a" name="direccion_general_a_a" placeholder="Titulo">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-1 control-label" for="general_b">B</label>
                                                    <div class="col-md-3">
                                                        <input class="form-control" type="text" id="direccion_general_a_b" name="direccion_general_a_b" placeholder="Titulo">
                                                    </div>
                                                </div>
                                                <h5>Dirección general "B"</5></br></br>
                                                <div class="form-group">
                                                    <label class="col-md-1 control-label" for="general_b">A</label>
                                                    <div class="col-md-3">
                                                        <input class="form-control" type="text" id="direccion_general_b_a" name="direccion_general_b_a" placeholder="Titulo">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-1 control-label" for="general_b">B</label>
                                                    <div class="col-md-3">
                                                        <input class="form-control" type="text" id="direccion_general_b_b" name="direccion_general_b_b" placeholder="Titulo">
                                                    </div>
                                                </div>
                                            </fielset>
                                        </div>
