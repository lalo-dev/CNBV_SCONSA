            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> Cédula única de auditoría</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Auditoría</li>
                        <li>Cierre</li>
                        <li><a href="#">Cédula única de auditoría</a></li>
                        <li>Detalle</li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form class="form-horizontal push-10-t" onsubmit="return false;">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="orden"># Fecha Termino</label>
                                        <div class="col-md-3">
                                            <input class="js-datepicker form-control" type="text" id="example-datepicker1" name="example-datepicker1" data-date-format="mm/dd/yy" placeholder="mm/dd/yy">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="tiempo_real">Tiempo real</label>
                                        <div class="col-md-3">
                                    ...
                                    <blockquote>
                                        <div class="form-group">
                                            <fielset>
                                                ...
                                                <div class="block-content col-md-5">
                                                    ...
                                                    <table class="table table-condensed">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-center" style="width: 100px;">Miles de pesos</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Monto por aclar</td>
                                                                <td class="text-center"></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-center">4</td>
                                                                <td>Monto por recuperar</td>
                                                                <td class="text-center"></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
