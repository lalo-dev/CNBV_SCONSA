...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    ...
    <body>
                        ...
                        <div class="block-content tab-content bg-white">
                            ...
                            <div class="tab-pane fade fade-up in active" id="search-projects">
                                <div class="border-b push-30">
                                    <h2 class="push-10" id="label_ofcom"> <span class="h5 font-w400 text-muted">Auditorías encontradas</span></h2>
                                </div>
                                <table class="table table-striped table-vcenter table-condensed" id="oficio_complem" >
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php foreach ($get_ofcom as $key => $valuea): ?>
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-center"><?= $valuea->auditores; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
        ...
        <script type="text/javascript">
            $(function(){
                var trs =$("#oficio_complem tbody tr").length;
                $("#label_ofcom").text(trs);
            })
