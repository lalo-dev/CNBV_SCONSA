                                ...
                                <div class="block-content block-content-narrow">
                                    ...
                                    <form class="js-validation-material form-horizontal push-10-t" action="" id="add_revision" method="post">
                                        <div class="form-group">
                                            <div class="col-sm-3">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="form-control input-sm hidden" type="text" id="id_rev_form" name="id_rev_form" value="">
                                                    <input class="form-control input-sm" type="text" value="123" maxlength="60" id="no_revision" name="no_revision">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-primary floating">
                                                    <textarea class="form-control input-sm" id="descripcion" maxlength="1000" name="descripcion" rows="6">des</textarea>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-primary floating">
                                                    <textarea class="form-control input-sm" id="objetivo" maxlength="1000" name="objetivo" rows="6">des</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-material form-material-primary floating">
                                                    ...
                                                    <!--select class="form-control input-sm" id="ts_hombre" name="ts_hombre">
                                                        <option></option-->
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="js-datepicker form-control input-sm" value="<?= date("d/m/y") ?>" type="text" id="periodo_ini" name="periodo_ini" data-date-format="dd/mm/yy" placeholder="dd/mm/yy">
                                                    <label for="periodo_ini">P. Revisión Inicio</label>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-material form-material-primary floating">
                                                    <input class="js-datepicker form-control input-sm" value="<?= date("d/m/y") ?>" type="text" id="periodo_fin" name="periodo_fin" data-date-format="dd/mm/yy" placeholder="dd/mm/yy">
                                                    <label for="periodo_fin">P. Revisión Fin</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
