                                ...
                                <table class="table table-striped table-vcenter table-condensed">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <h3 class="h5 font-w600 push-10"> 
                                                        <a class="link-effect" href="<?=URL .'m1_0_0_form_pat/'. $value->pat_ano ?>"> <?= $value->pat_ano_des  ?> </a>
                                                    </h3>
                                                    <div class="push-10">
                                                        <span class="label label-warning"><i class="fa fa-refresh fa-spin"></i> En proceso</span>
                                                    </div>
                                                </td>
                                                <td class="h3 text-center"><?= $value->auditorias ?></td>
                                                <td class="h3 text-center"><?= $value->seguimientos ?></td>
                                        ...
                                        <!--tr>
                                            <td>
                                                <h3 class="h5 font-w600 push-10">
                                                    <a class="link-effect" href="m1_0_0_form_pat">Programa Anual de Trabajo 2016</a>
                                                </h3>
                                                <div class="push-10">    
