            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        <?= $id_pat; ?> <small>Mapa de riesgos</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Planeación anual</li>
                        <li><a class="link-effect" href="<?=URL .'m1_4_mapa_riesgos_index' ?>"> Mapa de riesgos </a></li>
                        <li><?= $id_pat; ?></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="block-content tab-content bg-white">
                    ...
                    <div class="tab-pane" id="btabs-alt-static-settings">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">   
                                <a class="block block-link-hover3 text-center" href="<?=URL ?>m1_4_mapa_riesgos_form/<?=$id_pat ?>">
                                    <div class="block-content block-content-full">
