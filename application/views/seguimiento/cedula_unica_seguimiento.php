                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Cédula única de seguimiento<small> Seguimiento</small>
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Seguimiento</li>
                                <li>Cédula única de seguimiento</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <h3 class="h5 font-w600 push-10">
                                                    <a class="link-effect" href="m3_form_cedula_unica_seguimiento_detalle">Auditoría XXXX XXXXX</a>
                                                </h3>
                                            </td>
