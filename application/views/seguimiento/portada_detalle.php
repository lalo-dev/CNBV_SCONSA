            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> Portada</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Seguimiento</li>
                        <li><a href="m3_portada">Portada</a></li>
						<li>Detalle</li>
                    </ol>
                </div>
            </div>
        ...
        <div class="content">
            <div class="block">
                <ul class="nav nav-tabs nav-tabs-alt" data-toggle="tabs">
                    ...
                    <li>
                        <a href="#sintitular">Sin titular</a>
                    </li>
                </ul>
                <div class="block-content tab-content bg-white">
                                            ...
                                            <div class="col-lg-4 col-lg-offset-2">
                                                <a class="block block-link-hover2" href="javascript:void(0)">
                                                    <div class="block-content block-content-full bg-flat clearfix">
                                                        ...
                                                        <span class="h4 font-w700 text-white">Portada </span>
                    ...
                    <!-- End Info -->
                    <!-- cedula unica de portada-->
                    <div class="tab-pane fade fade-up" id="portada">
                        <form class="form-horizontal push-10-t" onsubmit="return false;">
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-md-offset-2">
                                    <div class="form-material floating">
                                        <input class="form-control" type="text" id="Conclusion" name="Conclusion">
                                        <label for="Conclusion">Conclusión</label>
                                    </div>
                                </div>
                                <div class="col-md-7 col-md-offset-2">
                                    <div class="form-material floating">
                                        <input class="form-control" type="text" id="con_fecha" name="con_fecha">
                                        <label for="con_fecha">Con fecha</label>
                                    </div>
                                </div>
                                <div class="col-md-7 col-md-offset-2">
                                    <div class="form-material floating">
                                        <input class="form-control" type="text" id="con_de" name="con_de">
                                        <label for="con_de">Consta de</label>
                                    </div>
                                </div>
                                <div class="col-md-7 col-md-offset-2">
                                    <div class="form-material floating open">
                                        <select class="form-control" id="hasta" name="hasta" size="1">
                                ...
                                <div class="col-md-7 col-md-offset-2">
                                    <div class="form-material floating">
                                        <input class="form-control" type="text" id="calculo" name="calculo">
                    ...
                    <!-- End cedula unica de portada -->
                    <!-- cedula sin titular-->
                    <div class="tab-pane fade fade-up" id="sintitular">
                        <form class="form-horizontal push-10-t" onsubmit="return false;">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="col-sm-1 col-sm-offset-5">
                                ...
                                <div class="col-md-7 col-md-offset-2">
                                    <div class="form-material floating">
                                        <input class="form-control" type="text" id="oficio" name="oficio">
                                        <label for="oficio">Oficio</label>
                                    </div>
                                </div>
                                <div class="col-md-7 col-md-offset-2">
                                    <div class="form-material floating">
                                        <input class="form-control" type="text" id="foficio" name="foficio">
                                        <label for="foficio">Fecha oficio</label>
                                    </div>
                                </div>
