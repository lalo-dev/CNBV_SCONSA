                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Requerimiento de Información<small> Seguimiento</small>
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Seguimiento</li>
                                <li>Requerimiento de Información</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <h3 class="h5 font-w600 push-10">
                                                    <a class="link-effect" href="m3_form_requerimiento_inf_detalle">Auditoría XXXX XXXXX</a>
                                                </h3>
                                            </td>
