            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> Índice del legajo de seguimiento</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Seguimiento</li>
                        <li><a href="m3_indice_legajo">Índice del legajo de seguimiento</a></li>
						<li>Detalle</li>
                    </ol>
                </div>
            </div>
        ...
        <div class="content">
            <div class="block">
                ...
                <div class="block-content tab-content bg-white">
                                            ...
                                            <div class="col-lg-4 col-lg-offset-2">
                                                <a class="block block-link-hover2" href="javascript:void(0)">
                                                    <div class="block-content block-content-full bg-flat clearfix">
                                                        ...
                                                        <span class="h4 font-w700 text-white">Índice del legajo </span>
                    ...
                    <!-- End Info -->
                    <!-- cedula unica de indice-->
                    <div class="tab-pane fade fade-up" id="indice">
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="table-responsive border">
                                        <table class="table table-condensed" style="font-size: 10px;">
                                            ...
                                            <tr>
                                                <td></td>
                                                <td rowspan="2" class="text-center" style="vertical-align: middle;"><strong>Legajo</strong></td>
                                                <td colspan="2" class="text-center">Folio</td>

                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td class="text-center"><strong>Del</strong></td>
                                                <td class="text-center"><strong>AI</strong></td>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                                <td>I. Índice del legajo de auditoría de seguimiento</td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>II. Oficio de resultados</td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>III. Evidencia documental</td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>IV. Cédula supervisión</td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>IV. Cédula única de seguimiento</td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
