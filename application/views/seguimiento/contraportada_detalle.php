            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> Contraportada</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Seguimiento</li>
                        <li><a href="m3_contraportada"> Contraportada</a></li>
						<li>Detalle</li>
                    </ol>
                </div>
            </div>
        ...
        <div class="content">
            <div class="block">
                <ul class="nav nav-tabs nav-tabs-alt" data-toggle="tabs">
                    ...
                    <li>
                        <a href="#portada">Contraportada</a>
                    </li>
                </ul>
                                            ...
                                            <div class="col-lg-4 col-lg-offset-2">
                                                <a class="block block-link-hover2" href="javascript:void(0)">
                                                    <div class="block-content block-content-full bg-flat clearfix">
                                                        ...
                                                        <span class="h4 font-w700 text-white">Contraportada </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="text-center">IV. Cedula</td>
                                            <td>X/X</td>
                                            <td>
                                                DEL X/X AL X/X
                                            </td>
