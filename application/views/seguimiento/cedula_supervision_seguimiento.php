                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Cédula de supervisión de seguimiento<small> Seguimiento</small>
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Seguimiento</li>
                                <li>Cédula de supervisión de seguimiento.</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content">
                    <div class="block">
                        ...
                        <div class="block-content tab-content bg-white">
                            <!-- Projects -->
                            <div class="tab-pane fade fade-up in active" id="cedula">
                                        ...
                                        <tr>
                                            <td>
                                                <h3 class="h5 font-w600 push-10">
                                                    <a class="link-effect" href="m3_form_cedula_supervision_seguim_detalle">Auditoría XXXX XXXXX</a>
                                                </h3>
                                            </td>
