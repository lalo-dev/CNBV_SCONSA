                    ...
                    <div class="tab-pane fade fade-up in active" id="search-projects">
                        ...
                        <table class="table table-striped table-vcenter table-condensed">
                            ...
                            <tr>
                                <td>
                                    <h3 class="h5 font-w600 push-10">
                                        <a class="link-effect" href="anexos_detalle/1<?php //echo $value->id_auditoria?>">Auditoría XXXX XXXXX</a>
                                    </h3>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <h3 class="h5 font-w600 push-10">
                                        <a class="link-effect" href="anexos_detalle/2<?php //echo $value->id_auditoria?>">Auditoría XXXX XXXXX</a>
                                    </h3>
                                </td>
                                <td class="text-left">Dirección general auditada</td>
                            ...
                            <tr>
                                <td>
                                    <h3 class="h5 font-w600 push-10">
                                        <a class="link-effect" href="anexos_detalle/3<?php //echo $value->id_auditoria?>">Auditoría XXXX XXXXX</a>
                                    </h3>
                                </td>
                                <td class="text-left">Dirección general auditada</td>
                            ...
                            <tr>
                                <td>
                                    <h3 class="h5 font-w600 push-10">
                                        <a class="link-effect" href="anexos_detalle/4<?php //echo $value->id_auditoria?>">Auditoría XXXX XXXXX</a>
                                    </h3>
                                </td>
                                <td class="text-left">Dirección general auditada</td>
