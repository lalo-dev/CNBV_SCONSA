...
var App = function() {
    ...
    var uiHelperCkeditor = function(){
        ...
        if (jQuery('#blog_des').length) {
            CKEDITOR.replace('blog_des');
            var element_del = 'elementspath,save,font,newpage,preview,print,templates,sourcearea,';
            element_del += 'pastetext,pastefromword,undo,';
            element_del += 'find,selectall,';
            element_del += 'forms,clipboard,'; 
            element_del += 'format,stylescombo,'; 
            element_del += 'specialchar,smiley,flash,iframe,'; 
            element_del += 'about,maximize,showblocks,'; 
            element_del += 'bidi,language,'; 
            element_del += 'scayt,tabletools,wsc'; 

            CKEDITOR.config.removePlugins =  element_del;
        }
    };
